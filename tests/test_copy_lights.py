...
class TestCopyFiles:
    ...
    def test_copy_files_calls_all_file_types(self, mock_delete, mock_copy_type):
        ...
        file_types_called = [
            call.kwargs["file_type"] for call in mock_copy_type.call_args_list
        ]
    ...
    def test_copy_files_with_debug(self, mock_delete, mock_copy_type):
        ...
        for call in mock_copy_type.call_args_list:
            assert call.kwargs["debug"] is True
...
class TestCopyFileType:
    ...
    def test_copy_file_type_invalid_type(self):
        ...
        with pytest.raises(Exception, match="unexpected image type"):
            copy_lights._copy_file_type(
                source_dir="/test/source",
                dest_dir="/test/dest",
                file_type="INVALID",
